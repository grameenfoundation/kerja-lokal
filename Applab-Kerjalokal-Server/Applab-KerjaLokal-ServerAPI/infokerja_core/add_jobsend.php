	...
	*/
	...
	if (sizeof($temp) > 0)
	{
		...
		*/
		...
		$sql = "INSERT INTO $t_jobs_send (job_id, subscriber_id, date_add, date_send, status, rel_id, job_n) VALUES ('".$jobs[0]["job_id"]."', '$subscriber_id', '$date_add', '$date_send','1','$rel_id','$job_n')";
		$sql = mysql_query($sql);
		...
		*/
			...
			// {"n_job":22,"n_qualified_job":22,"jobsend_id":"291","job_id":"202","status":"1"}
			// {"status":"0","msg":"No Result 2"}
	...
	else
	{
		...
		//$sql = "INSERT INTO $t_jobs_send (job_id, subscriber_id, date_add, date_send, status, rel_id) VALUES ('".$jobs[0]["job_id"]."', '$subscriber_id', '$date_add', '".date("Y-m-d", time()+(($a+1)*86400))."','1','$rel_id')";
		$sql = "INSERT INTO $t_jobs_send (job_id, subscriber_id, date_add, date_send, status, rel_id, job_n) VALUES ('1', '$subscriber_id', '$date_add', '$date_send','1','$rel_id','$job_n')";
		$sql = mysql_query($sql);
