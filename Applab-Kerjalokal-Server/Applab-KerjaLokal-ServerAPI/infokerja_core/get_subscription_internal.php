<?php
	...
	//if ($loc_title != "") $search .= "AND loc_title LIKE \"%$loc_title%\"";
...
//	$sql = "SELECT * FROM $t_subscribers WHERE country_id='$country_id'";
	...
	$sql .= "$t_rel_subscriber_cat.date_active AS start_date, $t_rel_subscriber_cat.date_expired AS end_date, ";
	...
	$sql .= "INNER JOIN $t_mentors ON $t_subscribers.mentor_id = $t_mentors.mentor_id ";
	
	$sql .= "LEFT JOIN $t_rel_subscriber_cat ON $t_subscribers.subscriber_id = $t_rel_subscriber_cat.subscriber_id ";
