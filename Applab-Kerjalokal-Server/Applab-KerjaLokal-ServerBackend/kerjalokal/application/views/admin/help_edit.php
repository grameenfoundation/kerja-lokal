...
<?php
	...
	echo "<div class='row'><div class='cell_key'>".form_label('Title', 'help_title')."</div>\n";
	echo "<div class='cell_val'>".form_input("help_title", $help_title ,"size=40 maxlength=100").form_error('help_title', '<div class="form_error" style="color:red">', '</div>')."</div></div>\n";
