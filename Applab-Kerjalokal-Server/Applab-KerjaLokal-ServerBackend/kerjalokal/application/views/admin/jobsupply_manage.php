...
<?php	
	...
	foreach ($jobcats["results"] as $jobcat)
	{
		...
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px;\" align=\"right\">".$nsubscriber[$jobcat["jobcat_id"]][1]["current"]."</div>";
		echo "</div>\n";
		
		
		echo "<div class=\"cell\">"; 
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px; \"><a href=\"".base_url()."admin/jobpost/manage/1/a_job_title/20/1/".$jobcat["jobcat_id"]."/jakarta/_/_/_/_/_/_/_/".date("Y-m-d")."/\">".$njob[$jobcat["jobcat_id"]][2]["current"]."</a></div>";				
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px; \"><a href=\"".base_url()."admin/jobpost/manage/1/a_job_title/20/1/".$jobcat["jobcat_id"]."/depok/_/_/_/_/_/_/_/".date("Y-m-d")."/\">".$njob[$jobcat["jobcat_id"]][4]["current"]."</a></div>";
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px; \"><a href=\"".base_url()."admin/jobpost/manage/1/a_job_title/20/1/".$jobcat["jobcat_id"]."/bogor/_/_/_/_/_/_/_/".date("Y-m-d")."/\">".$njob[$jobcat["jobcat_id"]][3]["current"]."</a></div>";
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px; \"><a href=\"".base_url()."admin/jobpost/manage/1/a_job_title/20/1/".$jobcat["jobcat_id"]."/tangerang/_/_/_/_/_/_/_/".date("Y-m-d")."/\">".$njob[$jobcat["jobcat_id"]][5]["current"]."</a></div>";
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px; \"><a href=\"".base_url()."admin/jobpost/manage/1/a_job_title/20/1/".$jobcat["jobcat_id"]."/bekasi/_/_/_/_/_/_/_/".date("Y-m-d")."/\">".$njob[$jobcat["jobcat_id"]][6]["current"]."</a></div>";
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px;\" align=\"right\">".$njob[$jobcat["jobcat_id"]][1]["current"]."</div>";
		echo "</div>\n";
		...
		echo "<div style=\"border-bottom:1px solid #ccc; border-right:1px solid #ccc; padding:5px;\" align=\"right\">".$val."</div>";
		echo "</div>\n";
		echo "</div>\n";
		
		$total  = $total + $nsubscriber[$jobcat["jobcat_id"]][1]["current"];
		$values = $values + $njob[$jobcat["jobcat_id"]][1]["current"];
		$subval = $subval + $njob[$jobcat["jobcat_id"]][2]["need"] + $njob[$jobcat["jobcat_id"]][4]["need"] + $njob[$jobcat["jobcat_id"]][3]["need"] + $njob[$jobcat["jobcat_id"]][5]["need"] + $njob[$jobcat["jobcat_id"]][6]["need"];
		//echo $val."<hr>";
	}
	$paging = "";	 
?>
...
<div class="row">
	...
	<div class="cell table_head"><? echo "<div align=\"right\">".$total."</div>" ?></div>
	<div class="cell table_head"><? echo "<div align=\"right\">".$values."</div>" ?></div>
	<div class="cell table_head"><? echo "<div align=\"right\">".$subval."</div>" ?></div>	
</div>
