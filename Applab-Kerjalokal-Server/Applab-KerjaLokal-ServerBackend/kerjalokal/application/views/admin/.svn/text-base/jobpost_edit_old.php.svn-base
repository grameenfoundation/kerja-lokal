...
<?php
	...
	echo "<div class='cell_val'>".form_input("title", $title ,"size=40 maxlength=20").form_error("title", "<div class='form_error'>", "</div>")."</div></div>\n";
	...
	echo "<div class='cell_val'>".form_input("description", $description ,"size=40 maxlength=95")." (max. 95 character)";
	...
	echo "<div class='cell_val'>".form_input("comp_name", $comp_name ,"size=10 maxlength=10 id='comp_name'").form_error("comp_name", "<div class='form_error'>", "</div>")."</div></div>\n";
	
	echo "<div class='row'><div class='cell_key'>".form_label('Contact Person', 'comp_cp')."</div>\n";
	echo "<div class='cell_val'>".form_input("comp_cp", $comp_cp ,"size=40 maxlength=10 id='comp_cp'").form_error("comp_cp", "<div class='form_error'>", "</div>")."</div></div>\n";
	echo "<div class='row'><div class='cell_key'>".form_label('Phone', 'comp_tel')."</div>\n";
	echo "<div class='cell_val'>".form_input("comp_tel", $comp_tel ,"size=10 maxlength=10 id='comp_tel'").form_error("comp_tel", "<div class='form_error'>", "</div>")."</div></div>\n";
	echo "<div class='row'><div class='cell_key'>".form_label('Fax', 'comp_fax')."</div>\n";
	echo "<div class='cell_val'>".form_input("comp_fax", $comp_fax ,"size=10 maxlength=10 id='comp_fax'").form_error("comp_fax", "<div class='form_error'>", "</div>")."</div></div>\n";
