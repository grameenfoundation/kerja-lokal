...
<div class="table">
<div class="row">
	<div class="cell table_head" style="width:50px"><a href="<?php echo base_url()."admin/jobposter_company/manage/$page/$next_order"."_jobposter_id/$filter"; ?>">ID</a></div>	
	<div class="cell table_head"><a href="<?php echo base_url()."admin/jobposter_company/manage/$page/$next_order"."_username/$filter"; ?>">Username</a></div>
	<div class="cell table_head"><a href="<?php echo base_url()."admin/jobposter_company/manage/$page/$next_order"."_password/$filter"; ?>">Password</a></div>
	<div class="cell table_head"><a href="<?php echo base_url()."admin/jobposter_company/manage/$page/$next_order"."_userlevel/$filter"; ?>">Level</a></div>
	<div class="cell table_head"><a href="<?php echo base_url()."admin/jobposter_company/manage/$page/$next_order"."_email/$filter"; ?>">Email</a></div>
	<div class="cell table_head"><a href="<?php echo base_url()."admin/jobposter_company/manage/$page/$next_order"."_status/$filter";?>">Status</a></div>
</div>
<?php
	$a = "";
	foreach ($results as $jobposter)
	{
		...
		echo "<div class=\"cell table_cell\"><a href=\"".base_url()."admin/jobposter_company/edit/".$jobposter["jobposter_id"]."\">". $jobposter["username"]."</a></div>\n";
	...
	if ($npage > 1)
		for ($a = 1; $a <=$npage; $a++) 
			if ($a == $page)
				...
				$paging .= "<a href=\"".base_url()."admin/jobposter_company/manage/$a/$order/$filter\">$a</a> - ";
		
	$paging = substr($paging,0,strlen($paging)-3);
	echo $paging."<br><br>";
	//echo form_submit("submit", "Disabled selected job post");
	echo form_close();
	echo "<br><br><a href=\"".base_url()."admin/jobposter_company/save_csv/$order/$filter\">Save as CSV</a>";
?>
</div>