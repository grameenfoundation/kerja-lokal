...
<div style="display:inline; width:1%;">
	<div class="row">
		...
		<?php echo form_input("subscriber_name", ($subscriber_name ? $_GET['subscriber_name'] : '')); ?>
		</div>
	</div>
	<div class="row">
		<div class="cell table_cell" style="border:0px; text-align:right;">Mentor</div>
		<div class="cell table_cell" style="border:0px; text-align:left;">
		<?php echo form_input("mentor_name", ($mentor_name ? $_GET['mentor_name'] : '')); ?>
		</div>
	</div>
	<div class="row">
...
<div style="display:inline; width:1%;">
	...
	<div class="row">
		...
		<div class="cell table_cell" style="border:0px; text-align:left;"><input type="text" name="date_active[from_date]" size="14" maxlength="100" class="date-pick" id="SubDateFrom"></div>
	</div>
	<div class="row">
		<div class="cell table_cell" style="border:0px; text-align:right;"><i>End</i></div>
		<div class="cell table_cell" style="border:0px; text-align:left;"><input type="text" name="date_active[to_date]" size="14" maxlength="50" class="date-pick" id="SubDateTo"></div>
	</div>	
	<div class="row">
