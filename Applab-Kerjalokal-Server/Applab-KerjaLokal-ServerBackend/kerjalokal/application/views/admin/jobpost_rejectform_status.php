...
<div class="row">
<div class="cell table_cell" style="border:0px; text-align:left;">Anda Akan Inactive Job ini </div>
</div>
<div class="row">
...
<div class="row">
<div class="cell table_cell" style="border:0px; text-align:right;"><a href=# class=close style='padding: 6px;border:1px solid;background-color:#ccc'>Cancel</a>&nbsp;&nbsp;<input type="submit" name="submit" value="Inactive"></div>
</div>
</div>
</body>
</html>