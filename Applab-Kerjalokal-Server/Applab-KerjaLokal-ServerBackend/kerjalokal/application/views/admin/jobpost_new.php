...
*/
	...
	//echo "<a href=\"".base_url()."admin/jobpost/view/".$data["comp_name"]."\">". $data["comp_name"]."</a>";
	
	echo "<div class='row'><div class='cell_key'>";
	echo "<div class='cell_val'>".form_reset("discard","Discard")."</div>";
	//echo "<div class='cell_val'>".form_button("save","Save as Draft",$jsdraft)."</div>";
	echo "<div class='cell_val'><input type=\"button\" value=\"Save as Draft\" id=\"btndraft\" $jsdraft/></div>";	
	echo "<div class='cell_val'>".form_button("next","Next",$jsnext)."</div>";
